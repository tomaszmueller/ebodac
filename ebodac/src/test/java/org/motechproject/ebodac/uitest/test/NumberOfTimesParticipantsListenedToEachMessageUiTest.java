...
public class NumberOfTimesParticipantsListenedToEachMessageUiTest extends TestBase {
    ...
    @Test // EBODAC-808
    public void numberOfTimesParticipantsListenedToEachMessageTest() throws Exception {
        //        try {
        ...
        reportPage.showNumberOfTimesListenedReport();
        ...
        assertTrue(numberOfTimesListenedReportPage.checkColumns());
        reportPage.sleep(SLEEP_2SEC);
