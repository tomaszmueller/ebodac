...
public class StatisticServiceImpl implements StatisticService {
    ...
    private IvrAndSmsStatistic executeQueryWithParams(Query query, Range<DateTime> dateRange) {
    ...
    public IvrAndSmsStatistic getStatisticForQuery(final Range<DateTime> dateRange, final String query) {
        if (dateRange == null || dateRange.getMin() == null || dateRange.getMax() == null) {
            return null;
        }

        IvrAndSmsStatistic ivrAndSmsStatistic = ivrAndSmsStatisticReportDataService.executeSQLQuery(new SqlQueryExecution<IvrAndSmsStatistic>() {
            @Override
